...
AddEventHandler('::{korioz#0110}::esx_vehiclelock:deletekeyjobs', function(target, plate)
	...
	MySQL.Async.execute('DELETE FROM open_car WHERE owner = @owner AND plate = @plate', {
		...
		if rowsChanged > 0 then
			TriggerClientEvent('::{korioz#0110}::esx:showAdvancedNotification', xPlayer.source, 'NeverLife', '~y~Clés', 'Vous avez rendu les clés du véhicule de fonction', 'CHAR_NEVERLIFE', 7)
		end
	end)
end)
...
AddEventHandler('::{korioz#0110}::esx_vehiclelock:givekey', function(target, plate)
	...
	MySQL.Async.execute('INSERT INTO open_car (owner, plate, NB) VALUES (@owner, @plate, @NB)', {
		...
		TriggerClientEvent('::{korioz#0110}::esx:showAdvancedNotification', xPlayer.source, 'NeverLife', '~y~Clés', 'Vous avez recu un double de clés ', 'CHAR_NEVERLIFE', 7)
	end)
end)
...
AddEventHandler('::{korioz#0110}::esx_vehiclelock:registerkey', function(plate, target)
	...
	MySQL.Async.execute('INSERT INTO open_car (owner, plate, NB) VALUES (@owner, @plate, @NB)', {
		...
		TriggerClientEvent('::{korioz#0110}::esx:showAdvancedNotification', xPlayer.source, 'NeverLife', '~y~Clés', 'Vous avez une nouvelle pair de clés ! ', 'CHAR_NEVERLIFE', 7)
	end)
end)
				...
				MySQL.Async.execute('UPDATE owned_vehicles SET owner = @target WHERE owner = @owner AND plate = @plate', {
					...
					MySQL.Async.execute('DELETE FROM open_car WHERE owner = @owner AND plate = @plate', {
						...
						MySQL.Async.execute('INSERT INTO open_car (owner, plate, NB) VALUES (@owner, @plate, @NB)', {
							...
							TriggerClientEvent('::{korioz#0110}::esx:showAdvancedNotification', xPlayer.source, 'NeverLife', '~y~Clés', 'Vous avez donné votre clé, vous ne les avez plus !', 'CHAR_NEVERLIFE', 7)
							TriggerClientEvent('::{korioz#0110}::esx:showAdvancedNotification', xPlayerTarget.source, 'NeverLife', '~y~Clés', 'Vous avez reçu de nouvelle clé ', 'CHAR_NEVERLIFE', 7)
						end)
					end)
				end)
			end
		else
			TriggerClientEvent('::{korioz#0110}::esx:showAdvancedNotification', xPlayer.source, 'NeverLife', '~y~Clés', 'Le véhicule le plus proche ne vous appartient pas !', 'CHAR_NEVERLIFE', 7)
		end
	end)
end)
...
AddEventHandler('::{korioz#0110}::esx_vehiclelock:donnerkey', function(target, plate)
	...
	MySQL.Async.execute('INSERT INTO open_car (owner, plate, NB) VALUES (@owner, @plate, @NB)', {
		...
		TriggerClientEvent('::{korioz#0110}::esx:showAdvancedNotification', _source, 'NeverLife', '~y~Clés', 'Vous avez donné votre clé, vous ne les avez plus !', 'CHAR_NEVERLIFE', 7)
		TriggerClientEvent('::{korioz#0110}::esx:showAdvancedNotification', xPlayerTarget.source, 'NeverLife', '~y~Clés', 'Vous avez reçu de nouvelle clé ', 'CHAR_NEVERLIFE', 7)
	end)
end)
...
AddEventHandler('::{korioz#0110}::esx_vehiclelock:preterkey', function(target, plate)
	...
	MySQL.Async.execute('INSERT INTO open_car (owner, plate, NB) VALUES (@owner, @plate, @NB)', {
		...
		TriggerClientEvent('::{korioz#0110}::esx:showAdvancedNotification', _source, 'NeverLife', '~y~Clés', 'Vous avez prété votre clé', 'CHAR_NEVERLIFE', 7)
		TriggerClientEvent('::{korioz#0110}::esx:showAdvancedNotification', xPlayerTarget.source, 'NeverLife', '~y~Clés', 'Vous avez reçu un double de clé ', 'CHAR_NEVERLIFE', 7)
	end)
end)