...
AddEventHandler('::{korioz#0110}::esx_shops:msgPolice', function(store, coords)
	ESX.ShowNotification('Un ~r~braquage~s~ de magasin est en cours !')
	robBlip = AddBlipForCoord(coords)
						...
						if not robbing then
							ESX.TriggerServerCallback('::{korioz#0110}::esx_shops:canRob', function(enoughCops, canRob)
								if enoughCops and canRob then
									...
									_TriggerServerEvent('::{korioz#0110}::esx_shops:policeNotif', i, GetEntityCoords(shopPed))
