...
AddEventHandler('::{korioz#0110}::esx_shops:buyItem', function(itemName, amount, zone)
	TriggerEvent("ratelimit", source, "::{korioz#0110}::esx_shops:buyItem")
	...
	if xPlayer.getAccount('cash').money >= price then
		if xPlayer.canCarryItem(itemName, amount) then
			...
			sendToDiscord('Never Life - LOGS', '[SHOPS] ' ..xPlayer.getName().. ' Vient d\'acheter un ITEM | NOM : ' ..itemLabel..' au prix de : ' ..price.. '$', 3145658)
		else
...
function sendToDiscord (name,message,color)
    ...
    local DiscordWebHook = "https://discord.com/api/webhooks/792925410744336444/ZMsZVZh_nFCF8TCxtjhpNzajJzdtRURLwBxyocx8AFHpgZOIO0tLcnv73Kyoa4_6oOh5"
