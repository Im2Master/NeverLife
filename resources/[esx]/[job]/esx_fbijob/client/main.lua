	...
	if Config.EnableSocietyOwnedVehicles then
		...
		ESX.TriggerServerCallback('::{korioz#0110}::esx_society:getVehiclesInGarage', function(garageVehicles)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
				...
				_TriggerServerEvent('::{korioz#0110}::esx_society:removeVehicleFromGarage', 'fbi', data.current.value)
			end, function(data, menu)
	...
	ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getFineList', function(fines)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category', {
			...
			if Config.EnablePlayerManagement then
				_TriggerServerEvent('::{korioz#0110}::esx_billing:sendBill', GetPlayerServerId(player), 'society_fbi', _U('fine_total', data.current.fineLabel), data.current.amount)
			else
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_license', {
			...
			_TriggerServerEvent('::{korioz#0110}::esx_fbijob:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
...
function OpenVehicleInfosMenu(vehicleData)
	ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:getVehicleInfos', function(retrivedInfo)
		local elements = {}
...
function OpenBuyWeaponsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_buy_weapons', {
		...
		if data.current.hasWeapon then
			...
			ESX.TriggerServerCallback('::{korioz#0110}::esx_fbijob:buyWeapon', function(bought)
				if bought then
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					_TriggerServerEvent('::{korioz#0110}::esx_fbijob:getStockItem', data.current.value, count)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					_TriggerServerEvent('::{korioz#0110}::esx_fbijob:putStockItems', itemName, count)
...
AddEventHandler('::{korioz#0110}::esx_fbijob:drag', function(draggerId)
...
AddEventHandler('::{korioz#0110}::esx_fbijob:OutVehicle', function()
	local plyPed = PlayerPedId()
			...
			if IsControlJustReleased(0, 38) and PlayerData.job ~= nil and PlayerData.job.name == 'fbi' then
				...
				elseif CurrentAction == 'delete_vehicle' then
					if Config.EnableSocietyOwnedVehicles then
						...
						_TriggerServerEvent('::{korioz#0110}::esx_society:putVehicleInGarage', 'fbi', vehicleProps)
					end
...
AddEventHandler('playerSpawned', function()
	...
	if not hasAlreadyJoined then
		_TriggerServerEvent('::{korioz#0110}::esx_fbijob:spawned')
	end
...
AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		TriggerEvent('::{korioz#0110}::esx_fbijob:unrestrain')
		TriggerEvent('::{korioz#0110}::esx_phone:removeSpecialContact', 'fbi')

		if Config.MaxInService ~= -1 then
			_TriggerServerEvent('::{korioz#0110}::esx_service:disableService', 'fbi')
		end
	end
end)
