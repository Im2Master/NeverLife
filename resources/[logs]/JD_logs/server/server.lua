...
function discordLog(message, color, channel)
  if Config.AllLogs then
	PerformHttpRequest(Config.webhooks["all"], function(err, text, headers) end, 'POST', json.encode({username = Config.username, embeds = {{["color"] = color, ["author"] = {["name"] = Config.communtiyName,["icon_url"] = Config.communtiyLogo}, ["description"] = "".. message .."",["footer"] = {["text"] = "© https://discord.gg/neverlife - "..os.date("%x %X %p"),["icon_url"] = "https://media.discordapp.net/attachments/776315529173532682/777020972628312104/RRP_Logo.gif",},}}, avatar_url = Config.avatar}), { ['Content-Type'] = 'application/json' })
  end
	PerformHttpRequest(Config.webhooks[channel], function(err, text, headers) end, 'POST', json.encode({username = Config.username, embeds = {{["color"] = color, ["author"] = {["name"] = Config.communtiyName,["icon_url"] = Config.communtiyLogo}, ["description"] = "".. message .."",["footer"] = {["text"] = "© https://discord.gg/neverlife - "..os.date("%x %X %p"),["icon_url"] = "https://media.discordapp.net/attachments/776315529173532682/777020972628312104/RRP_Logo.gif",},}}, avatar_url = Config.avatar}), { ['Content-Type'] = 'application/json' })
end
