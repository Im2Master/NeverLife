---@type table
local Colour = {
    Background = { Dictionary = "sooyoanalanal", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 112 },
    LeftArrow = { Dictionary = "sooyoanalanal", Texture = "arrowleft", X = 7.5, Y = 15, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "sooyoanalanal", Texture = "arrowright", X = 393.5, Y = 15, Width = 30, Height = 30 },
