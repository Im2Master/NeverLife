...
AddEventHandler('korioz:init', function()
			...
			if Player.Exist and not Player.Dead and Player.OnFoot then
				...
				if newWeap ~= currWeapon then
					...
					if (weapons[newWeap] ~= nil) and (weapons[newWeap].parameters.onlyBag) then
						...
						if bagIndex == 21 or bagIndex == 40 or bagIndex == 40 or bagIndex == 41 or bagIndex == 44 or bagIndex == 45 then
						else
	...
	Citizen.CreateThread(function()
		local crosshairDisabled = exports['serverdata']:GetData('crosshairDisabled')
