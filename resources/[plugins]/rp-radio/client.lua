    ...
    while true do
        ...
        if Radio.Open then
            ...
            if not Radio.On then
                AddTextComponentSubstringPlayerName(Radio.Clicks and "~r~Éteindre~w~" or "~g~Allumer~w~")
            end
